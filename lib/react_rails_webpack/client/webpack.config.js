...
var config = getConfig({
  ...
  html: function (data) {
    ...
    var featureExamplesComponent = "<div class=\"react-component-target\" data-componentname=\"FeatureExamples\"></div>"
        ...
        data.defaultTemplate(
          {
            ...
            html: (sourceFileNote + plainReactComponent + reduxComponent + featureExamplesComponent)
          }
        )
    }
  },
